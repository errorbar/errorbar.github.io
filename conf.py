...
BLOG_TITLE = "Error Bar Podcast"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://errorbar.co.uk/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://errorbar.co.uk/"
BLOG_EMAIL = "andy.j.leonard@gmail.com"
BLOG_DESCRIPTION = "Website for Error Bar - the science and politics podcast."  # (translatable)
